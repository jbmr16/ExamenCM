...
- (void)initController {
    ...
    self.shopDetails   = [[NSMutableArray alloc] initWithObjects: @"Crafted in beautiful 100% cotton gabardine, these chinos are as comfortable as they are colorful. A smart, casual design to wear with a striped shirt or polo from the collection.", @"Graduate to style this season with the college spirit of this Lacoste Live jacket in cotton flannel. Takes midseason fashion to an unprecedented degree.", @"Lacoste Necklace CROC 700930199, Color: Cerise, Size: One Size ", @"Perfect for work or play in crisp cotton, these slim-cut chinos add instant polish to your look- just add a polo and go.",@"Iconic, this slim fit Lacoste Live polo is crafted in durable 100% cotton mini piqué. An essential in all athletic wardrobes for comfort and freedom of movement. ",nil];
     self.shopPrice   = [[NSMutableArray alloc] initWithObjects: @".04", @".12", @"0.15", @"0.35",@"0.20",nil];
